...
class AuthController extends Controller
{
    public function signup(Request $request)
    {
        ...
        $user = new User([
            'name' => $request->name,
			'customer_type_id' => $request->userTypes,
		...
		$array = [
					...
					'name' =>  $user['name'],
					'jenis' =>  UserType::find($request->userTypes)->name,
					'email' =>  $user['email'],
					'phone' =>  $user['phone'],
				];
        // Mail::to("bowo.sarjito@solar-nusantara.id")->send(new Register($array));
        // Mail::to("felix.tanoto@solar-nusantara.id")->send(new Register($array));
        // Mail::to("farros.alfatih@solar-nusantara.id")->send(new Register($array));
        // Affiliate
