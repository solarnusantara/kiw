    ...
    public function index(Request $request, $slug = null)
    {
        ...
        if (Route::currentRouteName() == 'product') {
            ...
            if ($blog) {
                ...
                $meta['meta_image'] = $blog->meta_img ? api_asset($blog->meta_img) : $meta['meta_image'];
        ...
        $settings = [
			...
			'XenditPayment'=> get_setting('xendit_payment'), 
            'paymentMethods' => [
                [
            ...
            'general_settings' => [
                ...
                'currency' => [
                    ...
                    'currency_code' => Cache::remember('system_default_currency_code', 86400, function () {
                        return Currency::find(get_setting('system_default_currency'))->code;
                    }),
