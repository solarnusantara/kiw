...
class OrderController extends Controller
{
    ...
    $orderDetailsTotal = $order->orderDetails->sum('total');
    $totalTax = $order->orderDetails->sum('tax');
    $shippingCost = $order->shipping_cost;
    $couponDiscount = $order->coupon_discount;

	$grandTotal = $orderDetailsTotal - $totalTax + $shippingCost - $couponDiscount;
    ...
    return response()->json([
        ...
        'totalTax' => $totalTax,
        'shippingCost' => format_price($shippingCost),
        'couponDiscount' => $couponDiscount,
        'grandTotal' => format_price($grandTotal)
    ]);
	}
}
