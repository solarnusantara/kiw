...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::group(['prefix' => 'product'], function () {
		...
		Route::post('bulk-product-edit', [ProductController::class, 'bulkEdit'])->name('bulk-product-edit');
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
		...
		Route::delete('/product-exports/{id}', 'destroy')->name('product_exports.destroy');
        Route::post('/product-exports', 'storeExport')->name('product_exports.store');
		Route::get('/product-exports/{id}/preview', 'preview')->name('product_exports.preview');
        //Product Bulk Upload
        ...
        Route::get('/product-bulk-edit/index', 'index2')->name('product_bulk_edit.index');
        Route::post('/bulk-product-edit', 'edit_bulk_upload')->name('bulk_product_update');
        Route::post('/bulk-product-edit-taxes', 'edit_bulk_upload_taxes')->name('bulk_product_update_tax');
        ...
        Route::group(['prefix' => 'bulk-upload/download'], function() {
            ...
            Route::get('/tax', 'pdf_download_tax')->name('pdf.download_tax');
	...
	Route::post('/orders/update-shipping-cost', [OrderController::class, 'updateShippingCost'])->name('orders.update_shipping_cost');
	...
	Route::post('/create-invoice', [PaymentInvoiceController::class, 'createInvoice'])->name('xendit-create-invoice');
    //Coupons
