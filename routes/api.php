...
Route::group(['prefix' => 'v1', 'as' => 'api.'], function () {
	...
	Route::post('/xendit/fixed-va', [XenditController::class, 'createFixedVirtualAccount']);
	Route::get('/xendit/fixed-va/{id}', [XenditController::class, 'getFixedVirtualAccount']);
    Route::group(['prefix' => 'payment', 'middleware' => 'auth:api'], function () {
        Route::any('/{gateway}/pay', [PaymentController::class, 'payment_initialize']);
    });
	// sonia here
	Route::post('chats/sonia/send', [ControllersConversationController::class, 'aiStoreSonia']);
    ...
    Route::get('all-user-types', [UserController::class, 'get_all_types']);
    ...
    Route::group(['middleware' => ['auth:api', 'unbanned']], function () {
        ...
        Route::group(['prefix' => 'user'], function () {
			...
			// Add the new route for readNotification
			Route::post('read-notification/{notificationId}', [UserController::class, 'readNotification']);
...
Route::post('/webhook/invoice-paid', [InvoiceController::class, 'handleInvoicePaid']);
