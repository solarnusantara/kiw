                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <v-row>
                            ...
                            <v-col cols="12" sm="4" v-if="$store.getters['app/banners'].checkout_page && $store.getters['app/banners'].checkout_page.img && $store.getters['app/banners'].checkout_page.link">
                                <banner
                                    :loading="false"
...
export default {
    ...
    methods: {
        ...
        async getShippingCost(address_id) {
            ...
            this.selectedDeliveryOption = res.data.success ? "standard" : "standard";
        ...
        async proceedCheckout() {
            ...
            formData.append("payment_type", "xendit");
