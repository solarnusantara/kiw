<template>
    <div>
        <banner
        v-if="$store.getters['app/banners'].dashboard_page_top && $store.getters['app/banners'].dashboard_page_top.img && $store.getters['app/banners'].dashboard_page_top.link"
         :loading="false" :banner="$store.getters['app/banners'].dashboard_page_top"/>
