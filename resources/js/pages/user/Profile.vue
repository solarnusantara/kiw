            ...
            <v-col xl="8">
                <v-card elevation="0" class="mb-6">
                    ...
                    <v-form class="py-4"  v-on:submit.prevent="updateBasic()" enctype="multipart/form-data">
                        ...
                        <v-text-field :placeholder="$t('company_name')" v-model="form.company_name" variant="outlined" hide-details="auto" class="mb-3" disabled></v-text-field>

                        <label>{{ $t("Types") }}</label>
                        <v-text-field :placeholder="$t('customer_type')" v-model="form.customer_type" variant="outlined" hide-details="auto" class="mb-3" disabled></v-text-field>
...
export default {
    ...
    created(){
        ...
        this.form.customer_type = this.currentUser.customer_type
        this.form.company_name = this.currentUser.company_name
