    ...
    methods:{
        async getDetails() {
            ...
            if (res.data.success) {
                ...
                this.metaKeywords = res.data.data.meta_keywords;
                this.metaImage = res.data.data.meta_img;
                this.recentBlogs = res.data.recentBlogs.data;
                this.createdAt = res.data.recentBlogs.data.created_at;
                this.updatedAt = res.data.recentBlogs.data.updated_at;
            }else{
