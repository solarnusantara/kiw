<template>
  <div>
    <v-container class="pt-md-7 px-0 px-md-3 pb-0" v-if="$store.getters['app/banners'].listing_page && $store.getters['app/banners'].listing_page.img && $store.getters['app/banners'].listing_page.link">
      <banner
        :loading="false"
