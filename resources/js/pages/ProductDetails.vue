      ...
      >
        <v-row>
          ...
          >
            ...
            <template v-if="$store.getters['app/banners'].product_page && $store.getters['app/banners'].product_page.img && $store.getters['app/banners'].product_page.link">
              <v-skeleton-loader
                type="image"
                height="200"
                class=""
            ...
            <template v-else>
              <banner v-if="$store.getters['app/banners'].product_page && $store.getters['app/banners'].product_page.img && $store.getters['app/banners'].product_page.link"
                :loading="false"
...
export default {
  ...
  watch:{
    ...
    metaImage(newImage){
      this.updateHead(this.metaTitle, this.metaDescription, newImage);
    }
  },
  methods: {
    ...
    async getDetails() {
      ...
      if (res.data.success) {
        ...
        this.idProduct = res.data.data.id;
        this.metaTitle = res.data.data.name;
        this.metaDescription = res.data.data.description.replace(/<[^>]*>?/gm, '');
        this.metaKeyword = res.data.data.description.replace(/<[^>]*>?/gm, '');
        this.metaImage = res.data.data.photos[0].url;
