              ...
              >
                <div class="px-lg-7">
                  ...
                  >
                    ...
                    <div class="mb-4">
                        <div class="mb-1 fs-13 fw-500">{{ $t('Types') }}</div>
                        <v-autocomplete
                        ...
                        ></v-autocomplete>
                        <p v-for="error of v$.form.userTypes.$errors" :key="error.$uid" class="text-red">
                            {{error.$message }}
                        </p>
                    </div>
...
export default {
  ...
  methods: {
    ...
    async fetchCountries(){
        if(!this.userTypesLoaded){
            const res = await this.call_api("get", "all-user-types");
            if(res.data.success){
                this.userTypesLoaded = true
