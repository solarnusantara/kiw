                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            @else
                                                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(static_asset('assets/img/logo.webp'))) }}" height="30"
                    ...
                    @foreach ($combined_order->orders as $order)
                        @foreach ($order->orderDetails as $key => $orderDetail)
                            @if ($orderDetail->product != null)
                                <tr>
                                    <td width="5%" style="border-bottom:1px solid #DEDEDE;">
                                    ...
                                    <td width="45%" class="" style="border-bottom:1px solid #DEDEDE;">
                                        {{ $orderDetail->quantity }}</td>
                                    <td width="13%"  class="" style="border-bottom:1px solid #DEDEDE;">
                                        {{ format_price($orderDetail->price) }}</td>
                                    <td width="15%" class="" style="border-bottom:1px solid #DEDEDE;">
                                        {{ format_price($orderDetail->tax) }}</td>
                                    <td width="9%" class="text-right bold" style="border-bottom:1px solid #DEDEDE;padding-right:20px;">
