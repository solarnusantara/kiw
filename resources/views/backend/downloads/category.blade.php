		...
		<table>
			<tr>
				<td>
					...
					@else
						<img src="{{ static_asset('assets/img/logo.webp') }}" height="40" style="display:inline-block;">
					@endif
				</td>
			</tr>
		</table>
		...
		<table class="padding text-left small border-bottom">
			...
			<tbody class="strong">
                 @foreach ($categories as $category)
                    @include('backend.downloads.child', ['category' => $category, 'level' => 0])
                @endforeach
            </tbody>
		</table>
	</div>
