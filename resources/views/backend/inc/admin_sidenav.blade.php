    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                ...
                @else
                    <img class="mw-100" src="{{ static_asset('assets/img/logo-white.webp') }}"
                        class="brand-icon" alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('product_bulk_import')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('product_bulk_edit.index') }}" class="aiz-side-nav-link" >
                                        <span class="aiz-side-nav-text">{{ translate('Bulk Edit') }}</span>
                                    </a>
                                </li>
                            @endcan
