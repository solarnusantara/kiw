                                ...
                                <div class="col-auto">
                                    <div class="media">
                                        ...
                                        @if (Auth::user()->id == $conversation->sender_id)
                                            <img @if ($conversation->receiver->avatar == null) src="{{ static_asset('assets/img/avatar-place.webp') }}" @else src="{{ uploaded_asset($conversation->receiver->avatar) }}" @endif onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.webp') }}';">
                                        @else
                                            <img @if ($conversation->sender->avatar == null) src="{{ static_asset('assets/img/avatar-place.webp') }}" @else src="{{ uploaded_asset($conversation->sender->avatar) }}" @endif class="rounded-circle" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/avatar-place.webp') }}';">
                                        @endif
                                    </span>
                                    </div>
                                </div>
